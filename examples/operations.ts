...
import { getFutureOperationV1FutureCardOperations, getHomeV2FirstAccount, getOperationV2Operations } from "../src";
...
void async function main () {
  ...
  const futureBalance = allFutureOperations.reduce((acc, operation) => acc + operation.montant_en_euro.montant, currentBalance);

  console.log(`Currently at ${currentBalance}, but will be at ${futureBalance.toFixed(2)} after all future operations.`);
